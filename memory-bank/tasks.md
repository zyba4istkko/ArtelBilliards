...
##### Frontend компоненты
- [ ] **ActiveGamePage.tsx** - основная страница игры
- [ ] **PlayerCard.tsx** - карточка игрока с шарами
- [ ] **ScoreModal.tsx** - модальное окно добавления очков
- [ ] **GameLog.tsx** - компонент игрового лога
- [ ] **GameTimer.tsx** - таймер игры
...
##### State management
- [ ] **Game state** - состояние текущей игры
  - Игроки и их очки
  - Забитые шары
  - Штрафы
  - Время начала игры
...
##### ⏳ Этап 4: Интеграция с API (НЕ НАЧАТ)
- [ ] Сохранение игровых событий в базе данных
- [ ] Загрузка состояния игры при перезагрузке
- [ ] Синхронизация между несколькими игроками
- [ ] Real-time обновления через WebSocket

##### ⏳ Этап 5: Финальная полировка (НЕ НАЧАТ)
...
#### 📚 Связанные файлы
- `react-app/src/pages/ActiveGamePage.tsx` ✅ СОЗДАН
- `react-app/src/App.tsx` ✅ ОБНОВЛЕН (добавлен маршрут)
- `react-app/src/pages/GameSessionPage.tsx` ✅ ОБНОВЛЕН (кнопка навигации)
- `react-app/src/components/ui/PlayerCard.tsx` (используется существующий)
- `react-app/src/components/ui/ScoreModal.tsx` (используется существующий)
- `react-app/src/components/ui/GameLog.tsx` (используется существующий)
- `react-app/src/api/services/gameService.ts` (расширение)
- `react-app/src/types/game.ts` (новые типы)
...
#### ✅ Критерии завершения
- [ ] Все компоненты используют NextUI
- [ ] MUI зависимости полностью удалены
- [ ] Дизайн консистентен по всему приложению
